CrossFit_D_Lt <- function(x, t, Folds, lrnrs) {
    if (t == x$vars$tau) {
    ...
    for (v in 1:Folds$V) {
        ...
        Tr_Ap <- x$stack_data(Folds$Tr(x$data, v),
                                 Folds$Tr(x$shifted_aprime, v), t)
        ...
        Tr_As <- x$stack_data(Folds$Tr(x$data, v),
                                 Folds$Tr(x$shifted_astar, v), t)
